...
export class GeneratePdfComponent implements OnInit {
  ...
  newValue() {
    ...
    for (let i = 0; i < this.workOrderReq.length; i++) {
      newTestArray.push([{ text: this.workOrderReq[i].item, style: 'rowStyle' }, { text: this.workOrderReq[i].quantity, style: 'rowStyle' },
      { text: this.workOrderReq[i].price.toFixed(2), style: 'rowStyle' },
      ...
      content: [
        ...
        },
        {
          ...
          table: {
            ...
            { text: this.workOrder[0].tax.toFixed(2), style: 'rowTotal' }],
            [{ text: '', style: 'rowStyle', border: [false, false, false, false] },
            { text: '', style: 'rowStyle', border: [false, false, false, false] }, {
              text: '',
              style: 'rowStyle', border: [false, false, false, false]
            }, { text: 'Amount', style: 'rowStyle' },
            { text: this.workOrder[0].allTotal.toFixed(2), style: 'rowTotal' }]
            ]
          },
        }, {
          style: 'tableExample',
